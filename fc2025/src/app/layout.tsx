...
export const metadata: Metadata = {
  ...
  icons: "https://pages.newstapa.org/2025/facecheck2025/images/icon/favicon.png",
  openGraph: {
    title: "2025 대선 팩트체크 - 뉴스타파 X 한국독립언론네트워크 KINN",
    description: "대선 후보들의 발언, 사실일까 거짓일까? 뉴스타파와 한국독립언론네트워크(KINN)가 팩트체크를 위해 뭉쳤습니다.",
    ...
    images: [
      {
        url: "https://pages.newstapa.org/2025/facecheck2025/images/share-banner_1200_logoX.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: '2025 대선 팩트체크 - 뉴스타파 X 한국독립언론네트워크 KINN',
    description: "대선 후보들의 발언, 사실일까 거짓일까? 뉴스타파와 한국독립언론네트워크(KINN)가 팩트체크를 위해 뭉쳤습니다.",
    images: ['https://pages.newstapa.org/2025/facecheck2025/images/share-banner_1200_logoX.jpg'],    
  }
};
